...
public class DiscordManager : MonoBehaviour {
	...
	public const string SKU_PUBLIC_KEY = "jL9otsgKnxrnH0Ma1BzchktLqIWfRGcY";
	...
	public long applicationID = 593719279161966592;
	...
	public Discord.Discord rawDiscordClient;
    ...
    public void Initialize()
    {
		...
		// Set raw discord client
		rawDiscordClient = new Discord.Discord(applicationID, (UInt64)Discord.CreateFlags.Default);
        ...
        _client = new DiscordRPC.DiscordRpcClient(
            applicationID.ToString(),                       //The Discord Application ID            
