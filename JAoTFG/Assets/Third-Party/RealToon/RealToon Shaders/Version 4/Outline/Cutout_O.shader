...
Shader "RealToon/Version 4/Outline/Cutout" {
    Properties {
        ...
        [Space(8)][Enum(VNormal,0,Origin,1)] _OutlineMethod("Outline Method", int) = 0
    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                _OM = lerp(v.normal,normalize(v.vertex),_OutlineMethod);
